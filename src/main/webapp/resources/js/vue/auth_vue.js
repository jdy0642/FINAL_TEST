...
auth_vue ={
	login_head: x=>{
		...
		'body {background-image : url("https://social.lge.co.kr/wp-content/uploads/2016/05/%EC%9E%90%EC%97%B0%EB%B3%BC%EB%A6%AC%EB%B9%84%EC%95%84-%EC%9C%A0%EC%9A%B0%EB%8B%88-%EC%86%8C%EA%B8%88-%EC%82%AC%EB%A7%89.jpg");'+
	...
	login_body: x=>{
        ...
        '      <li class="col-12 col-md-6 col-lg-3">'+
        '          <div class="cnt-block equal-hight" style="height: 349px;">'+
        '            <figure><img src="https://kmug.co.kr/data/file/design/data_design_cgv_logo.jpg" class="img-responsive" alt=""></figure>'+
